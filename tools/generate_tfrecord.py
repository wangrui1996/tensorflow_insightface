...
def get_args():
    ...
    parser.add_argument('--mode', type=str, help='from which to generate TFRecord, folders or mxrec', default='images')
...
if __name__ == "__main__":
    ...
    if args.mode == 'folders':
        ...
        cid.write_images_from_mxrec(args.read_dir, args.save_dir, args.thread_num)
    else:
